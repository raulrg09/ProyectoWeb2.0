    ...
    <div className="py-8">
        <div className="container">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                {/* Segunda columna */}
                <div className="py-10 pl-5 bg-gradient-to-br from-amarillo to-amarillo/80 text-white rounded-3xl relative h-[320px] flex items-end">
                    <div>
                        <div className="mb-4">
                ...
                {/* Tercera columna */}
                <div className="col-span-2 py-10 pl-5 bg-gradient-to-br from-primario to-primario/90 text-white rounded-3xl relative h-[320px] flex items-end">
                    <div>
                        <div className="mb-4">
                            <p className='mb-[2px] text-white'>Enjoy</p>
                            <p className='text-2xl font-semibold mb-[2px]'>With</p>
